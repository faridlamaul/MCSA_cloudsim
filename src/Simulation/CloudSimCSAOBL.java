...
//    private static final String datasetName = "SDSC";
    ...
    private static ArrayList<Double> getTaskValue ( int taskNum ) {
        ...
        try {
            if ( Objects.equals ( datasetName, "SDSC" ) ) {
                File fobj = new File ( System.getProperty ( "user.dir" ) + "/data/CSAOBL/SDSC/SDSC" + nTask + ".txt" );
                ...
                File fobj = new File ( System.getProperty ( "user.dir" ) + "/data/CSAOBL/Random/Simple/RandSimple" + nTask + ".txt" );
                ...
                File fobj = new File ( System.getProperty ( "user.dir" ) + "/data/CSAOBL/Random/Stratified/RandStratified" + nTask + ".txt" );
    ...
    private static ArrayList<Double> getAllocationTaskCSAValue ( int allocationTaskNum ) {
        ...
        ArrayList<Double> listOfAllocationTask = new ArrayList<Double> ( );

        try {
            if ( Objects.equals ( datasetName, "SDSC" ) ) {
                File fobj = new File ( System.getProperty ( "user.dir" ) + "/allocation/CSA/SDSC/SDSCAllocationFromCSA" + nTask + ".txt" );

                Scanner readFile = new java.util.Scanner ( fobj );

                while ( readFile.hasNextLine ( ) && allocationTaskNum > 0 ) {
                    // Adding the data to the listOfAllocationTask
                    listOfAllocationTask.add ( readFile.nextDouble ( ) );
                    allocationTaskNum--;
                }
                readFile.close ( );
            } else if ( Objects.equals ( datasetName, "Simple" ) ) {
                File fobj = new File ( System.getProperty ( "user.dir" ) + "/allocation/CSA/Random/Simple/SimpleRandomAllocationFromCSA" + nTask + ".txt" );
                ...
                File fobj = new File ( System.getProperty ( "user.dir" ) + "/allocation/CSA/Random/Stratified/StratifiedRandomAllocationFromCSA" + nTask + ".txt" );
    ...
    public static void main ( String[] args ) {
        ...
        Log.printLine ( "Starting Cloud Simulation Crow Search Algorithm and Opposition Based Learning ..." );
        ...
        try {
            ...
            // 6. Use Crow Search Algorithm and Opposition Based Learning (CSA-OBL) to allocate Cloudlets to VMs

            // Initializing parameters for CSA-OBL (flightLength, awarenessProbability, maxIteration)
            ...
            // Generate allocation using CSA-OBL
            ...
            if ( Objects.equals ( datasetName, "SDSC" ) ) {
                outputWriter = new BufferedWriter ( new FileWriter ( System.getProperty ( "user.dir" ) + "/allocation/CSAOBL/SDSC/SDSCAllocationFromCSA" + nTask + ".txt" ) );
                ...
                outputWriter = new BufferedWriter ( new FileWriter ( System.getProperty ( "user.dir" ) + "/allocation/CSAOBL/Random/Simple/SimpleRandomAllocationFromCSA" + nTask + ".txt" ) );
                ...
                outputWriter = new BufferedWriter ( new FileWriter ( System.getProperty ( "user.dir" ) + "/allocation/CSAOBL/Random/Stratified/StratifiedRandomAllocationFromCSA" + nTask + ".txt" ) );
            ...
            Log.printLine ( "Cloud Simulation Crow Search Algorithm and Opposition Based Learning finished!" );
        } catch (Exception e) {
            e.printStackTrace ( );
